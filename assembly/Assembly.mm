...
<node TEXT="&lt;html&gt;&#xa;  &lt;head&gt;&#xa;    &#xa;  &lt;/head&gt;&#xa;  &lt;body&gt;&#xa;    &lt;p&gt;&#xa;      I think DS, DB, DW are used to &lt;i&gt;Define&lt;/i&gt;&amp;#160;a variable of certain type.&#xa;    &lt;/p&gt;&#xa;  &lt;/body&gt;&#xa;&lt;/html&gt;" ID="ID_1740082859" CREATED="1479084899414" MODIFIED="1479084941774"/>
...
<node TEXT="DB    define byte" ID="ID_916129425" CREATED="1479084876402" MODIFIED="1479102660669">
...
<node TEXT="DW    define word  // (aka two bytes)" ID="ID_1137059508" CREATED="1479084890876" MODIFIED="1482922739696">
...
<node TEXT="ADD    HL, SP&#xa;ADD    SP, e8    // a byte representing 8bit offset" ID="ID_766695123" CREATED="1482111729646" MODIFIED="1482111772599">
...
<node TEXT="LD    HL, 2&#xa;ADD    HL, SP" ID="ID_1021653686" CREATED="1482111804174" MODIFIED="1482111868855">
...
<node TEXT="tips and tricks" POSITION="right" ID="ID_1851273030" CREATED="1481631107953" MODIFIED="1481631111328">
<edge COLOR="#808080"/>
...
<node TEXT="Syntax" POSITION="right" ID="ID_1953168260" CREATED="1479945216541" MODIFIED="1479945218077">
<edge COLOR="#808080"/>
...
<node TEXT="strsub" ID="ID_857898910" CREATED="1479945240342" MODIFIED="1479945244456">
...
<node TEXT="strin" ID="ID_1999636418" CREATED="1479945478370" MODIFIED="1479945480698">
...
<node TEXT="Macros" POSITION="right" ID="ID_855697522" CREATED="1479084679295" MODIFIED="1479084682397">
<edge COLOR="#808080"/>
...
<node TEXT="Troubleshooting" POSITION="left" ID="ID_1920539374" CREATED="1479294686181" MODIFIED="1479294691464">
<edge COLOR="#808080"/>
<node TEXT="If your program compiles fine but won&apos;t display anything" ID="ID_1088301421" CREATED="1479294693206" MODIFIED="1479294717844">
...
<node TEXT="xxxx: macro not defined" ID="ID_907061229" CREATED="1479711629785" MODIFIED="1479711636954">
<node TEXT="This means you&apos;ve typed in code AS IF you were calling a MACRO (likely)" ID="ID_578801451" CREATED="1479711638191" MODIFIED="1479711663346">
...
<node TEXT="macro argument not defined" ID="ID_1523636828" CREATED="1481527415026" MODIFIED="1481527420544">
<node TEXT="you&apos;ve already defined the macro, and now you&apos;re defining it again." ID="ID_1801952100" CREATED="1481527424935" MODIFIED="1481527459542">
...
<node TEXT="variable not defined" ID="ID_1997105168" CREATED="1479711812408" MODIFIED="1479711821131">
...
<node TEXT="unterminated IF construct" ID="ID_1368159546" CREATED="1479888882897" MODIFIED="1479888888092">
...
<node TEXT="syntax error" ID="ID_1732755487" CREATED="1483349674010" MODIFIED="1483349677349">
<node TEXT="Whoooo boy this ones a tough one. It usually means some unexpected syntax&#xa;( : , etc..) is missing or has been added where it shouldn&apos;t be.&#xa;Try to check the line which is specified" ID="ID_1005184809" CREATED="1483349679014" MODIFIED="1483349894201"/>
...
<node TEXT="Calling a variable as a macro call" ID="ID_1025815578" CREATED="1486078312876" MODIFIED="1486078327696">
...
<node TEXT="Not using \@ for macro .local labels" ID="ID_466854391" CREATED="1486078574127" MODIFIED="1486078590066">
...
<node TEXT="However, if a macro uses a .local label (and the macro is called twice in the same routine),&#xa;Then the .local label names will clash. rgbds will throw an error about `label already defined`" ID="ID_1790006524" CREATED="1486078728051" MODIFIED="1486078813211"/>
<node TEXT="To fix this, use \@ at the end of every .local label:&#xa;    inc    b&#xa;.loop\@&#xa;    ld    a, b" ID="ID_618504746" CREATED="1486078821183" MODIFIED="1486078845762"/>
...
<node TEXT="wishlist" POSITION="left" ID="ID_262095036" CREATED="1482746477725" MODIFIED="1482746480693">
<edge COLOR="#808080"/>
<node TEXT="resolve dynamically altered values (e.g. SCRN_X - 8)" ID="ID_1559874725" CREATED="1482918264215" MODIFIED="1482918299001">
...
<node TEXT="escape end-of-line for multi-line use in big macros" ID="ID_1285878643" CREATED="1482918280166" MODIFIED="1482918348628">
